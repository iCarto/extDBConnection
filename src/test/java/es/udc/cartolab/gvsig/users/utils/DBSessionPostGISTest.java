...
public class DBSessionPostGISTest {
	...
	public static void setUpBeforeClass() throws Exception {
		...
		DBSessionPostGIS.createConnection(TestProperties.server, TestProperties.port, TestProperties.database,
				TestProperties.schema, TestProperties.username, TestProperties.password);
